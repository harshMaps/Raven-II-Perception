...
def load_image_gt(dataset, config, image_id, augment=False, augmentation=None,
    ...
    print ("***********************************")
    print ("augmentation status ", augmentation)
    print ("***********************************")
...
def data_generator(dataset, config, shuffle=True, augment=False, augmentation=None,
                   random_rois=0, batch_size=32, detection_targets=False):
...
class MaskRCNN():
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        # Data generators
        augmentation = None #samin's input, should be removed ASAP
    ...
    def detect_old(self, images, verbose=0):
        print("in old model detection")
        ...
        result_new = [final_class_ids, final_rois]
        #print("model.py")
        #print(result_new)
        # List of results that are not background
        resultsidroi = []

        for r in range(len(result_new[0])):
            if result_new[0][r] != 4:
                obj = [result_new[0][r]]
                #coords1 = (result_new[1][r][1], result_new[1][r][0])
                coords1 = (result_new[1][r][1].astype(float), result_new[1][r][0].astype(float))
                obj.append(coords1)
                #coords2 = (result_new[1][r][3], result_new[1][r][2])
                coords2 = (result_new[1][r][3].astype(float), result_new[1][r][2].astype(float))
                obj.append(coords2)
                resultsidroi.append(obj)
        #print(resultsidroi)

        #print(result_new[0][r], result_new[1][r])
        #print ("changing the return in model.detct to default : Samin")
        return results
